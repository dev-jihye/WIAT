...
const CreatePost = () => {
  ...
  useEffect(async () => {
    ...
    if (docSnap.exists()) {
      ...
      setFilePreview(postData.attachmentUrl);
      setTitle(postData.title);
      setPosting(postData.text);
      setError(null);
      setLoading(false);
    } else {
      setError("404");
            ...
            <div className="pt-5 mx-4">
              <div className="flex justify-end">
                <Link
                  ...
                  className="bg-w py-2 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 hover:bg-gray-300 focus:outline-none focus:ring-0 focus:ring-offset-2 "
                >
                  Cancel
                </Link>
                <Btn
